...
export class AlistamientocrearComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private http: HttpClient,
    private router: Router, private _lightbox: Lightbox, private _lightboxEvent: LightboxEvent,
  ) {
...
*/
  ...
  QuitarObservable() {
    ...
    this.Consulta2 = TimerObservable.create(0, 1000).takeWhile(() => this.alive)
      .subscribe(() => {
  ...
  showAlert(evt: any, tipo) {
    switch (tipo) {
      case 'Material':
        this.confirmacionGuardarMaterial.show();
        break;
      case 'Fase1':
        this.confirmacionGuardarFase1.show();
        break;
      case 'Fase2':
        this.confirmacionGuardarFase2.show();
        break;
    }
